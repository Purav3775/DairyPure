...
from .models import Product, Customer, Cart, Payment, OrderPlaced, Wishlist, Contact, ChatbotConversation
...
# Define allowed topics for relevance filtering
allowed_topics = [
    "account", "login", "password", "order", "checkout", "payment", "subscription",
    "delivery", "refund", "return", "website", "customer support", "product", "help"
]
...
def chatbot_endpoint(request):
    ...
    try:
        ...
        if model is None:
            return JsonResponse({"response": "The AI service is currently unavailable. Please try again later or contact customer support."})

        try:
            # Add context
            context = "You are a helpful customer service chatbot for an e-commerce website. " \
                     "Provide concise, accurate information about accounts, orders, products, and services. " \
                     "If you're unsure about specific details, suggest contacting customer support."
            ...
            if hasattr(response, "text"):
                ...
                ai_response = "I'm sorry, but I couldn't generate a response."
